...
class StatsModelTest {
    ...
    fun periodForReturnsSelectedBackendPeriod() {
        val week = StatsPeriod(mileage = 10, fuelLiters = 5.0, recordsCount = 2)
        val month = StatsPeriod(mileage = 20, fuelLiters = 8.5, recordsCount = 4)
        val allTime = StatsPeriod(mileage = 84, fuelLiters = 10.0, recordsCount = 6)
        val stats = Stats(

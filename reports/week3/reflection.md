...
- Product Backlog refinement showed that MVP v1 had to stay narrow: registration, authorization, vehicle registration/display, and basic chat. Advanced AI features were correctly moved out of the current scope after the customer review in [customer-meeting-summary.md](./customer-meeting-summary.md).

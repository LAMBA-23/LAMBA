...
| Backend targeted Sprint 4 suite | Security and assistant regression around authentication, CORS, rate limiting, and chat answers | `docker compose run --rm backend pytest tests/test_auth.py tests/test_cors.py tests/test_rate_limiting.py tests/test_chat_ask.py -q` | Passed locally on 2026-07-10 during #282 verification: 32 tests passed | `backend/tests/test_auth.py`; `backend/tests/test_cors.py`; `backend/tests/test_rate_limiting.py`; `backend/tests/test_chat_ask.py` |
...
| `backend/tests/test_rate_limiting.py` | Provides automated evidence for QRT-008 |
...
- `backend/tests/test_rate_limiting.py` verifies chat endpoint rate limiting.
...
- [QRT-008](quality-requirement-tests.md#qrt-008-login-and-chat-request-rate-protection) is covered by `backend/tests/test_auth.py` and `backend/tests/test_rate_limiting.py`.
...
docker compose run --rm backend pytest tests/test_auth.py tests/test_cors.py tests/test_rate_limiting.py tests/test_chat_ask.py -q
```
